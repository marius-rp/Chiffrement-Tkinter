...
from utils.logicFunctions import executionEncryption, executionDecryption
...
fileMenu.add_command(label="Encryption", command=lambda: encryptionPage(window, tk, titleTextEncryption, descriptionTextEncryption, recoveryTextEncryption))
fileMenu.add_command(label="Decryption", command=lambda: decryptionPage(window, tk, titleTextDecryption, descriptionTextDecryption, recoveryTextDecryption))
